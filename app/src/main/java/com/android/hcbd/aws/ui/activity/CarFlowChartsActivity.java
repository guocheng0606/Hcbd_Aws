...
public class CarFlowChartsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        OkGo.<String>post(MyApplication.getInstance().getBsaeUrl() + HttpUrlUtils.pre_check_car_flow_url)
                .tag(this)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onStart(Request<String, ? extends Request> request) {
                        ...
                        ProgressDialogUtils.showLoading(CarFlowChartsActivity.this);
                    }
